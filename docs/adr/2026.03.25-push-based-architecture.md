...
- `checkup init/config`: Create and edit a `checkup.yaml` in the current directory with an easy to use form interface
- `checkup run`: Calculate metrics, configurable with command options to e.g. override the materializer to `console`
